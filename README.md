...
### WARNING: The current version of this package does only support Wagtail 4.x. If you want to use it with Wagtal 2.x - 3.x please use version 0.0.8 or version 0.1.0. See the changelog for more information.
