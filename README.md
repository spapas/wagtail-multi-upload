...
This project has been mainly implemented to cover my requirements; I'll try to keep it updated with new wagtail versions but I can't promise anything. It should work fine with *Wagtail 2.8-2.11* (I've used it with all these versions myself). For version 2.12 see #7; it works with the fix described there.
